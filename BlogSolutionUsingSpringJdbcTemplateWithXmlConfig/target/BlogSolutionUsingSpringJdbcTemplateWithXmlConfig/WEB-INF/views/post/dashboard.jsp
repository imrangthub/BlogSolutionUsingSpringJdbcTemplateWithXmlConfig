...
<jsp:include page="/WEB-INF/views/_partial/_header.jsp" />
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p><a class="btn btn-primary btn-lg pull-right" href="/BlogSolutionUsingSpringJdbcWithXmlConfig/post/create" role="button">Add new Post</a></p>
      </div>
    </div>
      ...
      <div class="row">
	    <c:forEach items="${postList }" var="post">
	       <div class="col-md-12 well">
	          ...
	          <a class="btn btn-default btn-warning" href="/BlogSolutionUsingSpringJdbcWithXmlConfig/post/edit/${post.id }" role="button">Edit</a>
	          <a class="btn btn-default  btn-danger" href="/BlogSolutionUsingSpringJdbcWithXmlConfig/post/delete/${post.id }" role="button">Delete</a>
	        </div>
