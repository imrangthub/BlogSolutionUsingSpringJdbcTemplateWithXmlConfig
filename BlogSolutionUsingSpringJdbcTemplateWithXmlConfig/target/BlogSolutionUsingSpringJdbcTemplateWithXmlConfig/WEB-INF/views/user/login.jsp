       ...
       <div class="container">
        <div class="card card-container">
            ...
            <p id="profile-name" class="profile-name-card"></p>
             ${message }
            <form class="form-signin" action="/BlogSolutionUsingSpringJdbcWithXmlConfig/auth/login" method="POST">
                ...
                <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit">Sign in</button>
                       ...
                       <a href="/BlogSolutionUsingSpringJdbcWithXmlConfig/user/reg" class="forgot-password">
                Registration now?
            </a>
        </div><!-- /card-container -->
    </div><!-- /container -->
