       ...
       <div class="container">
          ...
          <div class="row">
             <div class="col-md-6 col-md-offset-3">
               <form action="/BlogSolutionUsingSpringJdbcWithXmlConfig/user/reg" method="POST">
				...
				<a href="/BlogSolutionUsingSpringJdbcWithXmlConfig/auth/login" class="forgot-password">
                  Go to login?
                </a>
             </div>
            </div>
